...
class TestRepetir(unittest.TestCase):
    ...
    def test_repetir_saldo(self):
        ...
        iniciar(self.io)
        self.esperado.extend(["Seu saldo é de 10 R$", self.que_fazer, "Seu saldo é de 10 R$", self.que_fazer])
    ...
    def test_repetir_aplicar(self):
        ...
        iniciar(self.io)
        self.esperado.extend(["Aplicando 30 R$ em pé de meia", self.que_fazer, "Aplicando 30 R$ em pé de meia", self.que_fazer])
        self.assertEqual(self.io.impressoes, self.esperado)

    def test_repetir_transferir(self):
        self.io.mensagens = [self.modo, "transferir", "993200", "100", "repetir", "cancelar"]
        iniciar(self.io)
        self.esperado.extend(["Diga o número da conta", "Diga o valor", "Transferindo 100 R$ para a conta 993200", self.que_fazer, "Transferindo 100 R$ para a conta 993200", self.que_fazer])
        self.assertEqual(self.io.impressoes, self.esperado)
