...
class TestObterNumeroConta(unittest.TestCase):
    ...
    def test_numero_inicialmente_fornecido(self):
        resposta = {'_text': ['transfira 50 reias para a conta 488192'], 'entities': {'intent': [{'confidence': 0.999996102388, 'value': 'transferir'}], 'numero_conta': [{'confidence': 0.96676956764313, 'value': 488192, 'type': 'value'}], 'amount_of_money': [{'confidence': 0.75993545605875, 'value': 50, 'type': 'value'}]}, 'msg_id': '0FaTzFtaBI9mEE9dB'}
